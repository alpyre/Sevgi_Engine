...
#define MUIM_BobsheetCreator_SetHotspotMargins 0x80430419
///
///Includes
#include <string.h>
...
static ULONG m_New(struct IClass* cl, Object* obj, struct opSet* msg)
{
  ...
  TAG_MORE, msg->ops_AttrList)))
  {
    ...
    DoMethod(data->obj_table.small, MUIM_Notify, MUIA_Selected, MUIV_EveryTime, obj, 1,
      MUIM_BobsheetCreator_SetHotspotMargins);
...
SDISPATCHER(cl_Dispatcher)
{
  ...
  switch(msg->MethodID)
  {
    ...
    case MUIM_BobsheetCreator_SetHotspotMargins:
