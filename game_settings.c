...
static struct {
  ...
  "Color depth of the level display.\nThis should be compatible with the color depth of the tilesets.\n\nNOTE: This becomes the color depth of the foreground,\ntilemap (playfield 1) in DUALPLAYFIELD mode.",
  "Color depth of the parallaxing background bitmap in DUALPLAYFIELD mode.\nThis should be compatible with the ILBM image loaded for the background.",
  "Height of the parallaxing background bitmap in DUALPLAYFIELD mode.\nThis should be compatible with the ILBM image loaded for the background.",
  "Height of the stationary top panel for the level display\nwhich could be used as a dashboard to display lives,\nscores etc. A value of 0 disables it.",
  "Height of the stationary bottom panel for the level display\nwhich could be used as a dashboard to display lives,\nscores etc. A value of 0 disables it.",
  "Fetch mode for bitplanes in the level display.\nOnly available on AGA machines.\nValues more than 1 will lower available hardware sprites.",
  "Fetch mode for sprites in the level display.\nOnly available on AGA machines.\nHigher fetch modes will make wider hardware sprites possible.\nThe value here should be compatible with the sprite banks used.",
